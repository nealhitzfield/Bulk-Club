...
public:
    ...
    void setupUi(QDialog *AddMemberWindow)
    {
        ...
        AddMemberWindow->resize(393, 135);
        addButton = new QPushButton(AddMemberWindow);
        addButton->setObjectName(QStringLiteral("addButton"));
        addButton->setGeometry(QRect(300, 30, 91, 41));
        label_status = new QLabel(AddMemberWindow);
        label_status->setObjectName(QStringLiteral("label_status"));
        label_status->setGeometry(QRect(300, 80, 91, 31));
        widget = new QWidget(AddMemberWindow);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(11, 74, 271, 43));
